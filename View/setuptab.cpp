...
void SetupTab::on_btnDisconnect_clicked() { emit NotifyDiconnectClicked(); }

void SetupTab::on_btnSend_clicked() { emit NotifySendClicked(); }

void SetupTab::on_btnReceive_clicked() { emit NotifyReceiveClicked(); }

void SetupTab::on_btnClear_clicked() { ui->textInstrumentMessage->clear(); }
